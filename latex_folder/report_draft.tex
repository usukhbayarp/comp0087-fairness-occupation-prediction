...
\textit{Primary novel contribution} (to our knowledge, no prior work
on this dataset provides this):
(i)~token-level Integrated Gradients attribution tables stratified by
both profession and gender, with proxy stability compared across
encoder models.
\textit{Secondary novel contribution}:
(ii)~an erasure faithfulness validation of those attribution scores
on the Bias-in-Bios task.
...
rather than explicit gender indicators.
