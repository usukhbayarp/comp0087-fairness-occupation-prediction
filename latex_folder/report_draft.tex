...
Pythia-1.4B fine-tuned reaches F1\,=\,0.849, matching encoder
baselines (RoBERTa 0.851, DistilBERT 0.843); Pythia-160M fine-tuned
fails (F1\,$\approx$\,0.02), likely due to label-space collapse under
LoRA at insufficient capacity. Zero-shot F1 scales from 0.23 (160M)
to 0.57 (1.4B); few-shot hurts at smaller scales (410M: 0.557→0.391)
but recovers at 1.4B (0.578), suggesting a minimum capacity threshold.
Masking has negligible impact on task performance across all models.
